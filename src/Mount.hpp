...
// Configure the Focus driver.
    ...
    // Set the DEC limit position to the given stepper position. If upper is true, sets the upper limit, else the lower limit.
    void setDecLimitPosition(bool upper, long value);
